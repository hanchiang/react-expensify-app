                ...
                <div className="input-group">
                    <div className="input-group__item">
                        <input 
                            ...
                            onChange={this.handleTextFilterChange} placeholder="Search expenses"
                        />
                    </div>

                    <div className="input-group__item">
                        <select className="select" value={this.props.filters.sortBy} onChange={this.handleSortFilterChange} >
